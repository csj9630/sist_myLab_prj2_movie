...
<body>
    ...
    <div class="hero-section">
      <div
        class="bg-img"
        style="background-image: url(images/movie_bg.jpg)"
      ></div>
        ...
        <div class="tab-content active" id="info">
          <div class="content-box">
            <h2 class="content-title">
              인기 애니메이션 <span class="highlight-text">'체인소 맨'</span> 첫
              극장판 국내 상륙!
            </h2>

            <p class="content-text">
              압도적 배틀 액션이 스크린에서 폭발한다!<br />
              <br />
              데블 헌터로 일하는 소년 '덴지'는 조직의 배신으로 죽음에 내몰린
              순간<br />
            </p>
            <details class="content-summary">
              ...
              <p class="content-text">
                전기톱 악마견 '포치타'와의 계약으로 하나로 합쳐져<br />
                누구도 막을 수 없는 존재 '체인소 맨'으로 다시 태어난다.<br />
                <br />
                악마와 사냥꾼, 그리고 정체불명의 적들이 얽힌 잔혹한 전쟁
                속에서<br />
                '레제'라는 이름의 미스터리한 소녀가 '덴지' 앞에 나타나는데…<br />
                '덴지'는 사랑이라는 감정에 이끌려 지금껏 가장 위험한 배틀에 몸을
                던진다!<br />
              </p>
            </details>
            ...
            <div class="info-list">
              <p>
                <strong>상영시간</strong>2D Dolby v.zA(자막) · 2D Dolby(더빙) ·
                2D MX4D(자막) · 2D(자막)
              </p>
              <p>
                <strong>결제</strong>애니메이션 대여 · 애니메이션 / 100 코인
              </p>
              <p><strong>등급</strong>15세이상관람가</p>
              <p><strong>개봉일</strong>20XX.XX.XX</p>
            </div>
          </div>
        </div>
          ...
          <div class="content-box">
            <div class="comment-area">
              <h2 class="content-title" style="margin-bottom: 0">
                극장판 체인소 맨: 레제편에 대한 15,098개의 이야기가 있어요!
              </h2>
            ...
            <div class="comment-asdf">
              ...
              <div style="flex: 1">
                <div class="comment-input">
                  최근 극장판 체인소 맨: 레제편에 관한 평점 게시물이 늘고
                  있습니다. 영화의 어떤 점이 좋았는지 이야기해주세요.<br />
                </div>
        ...
        <div class="content-box">
          <div class="video-section">
            <div class="video-header">
              <h2 class="video-title">메인 예고편</h2>
              <!-- <div class="video-nav">
            ...
            <div class="comments-section">
              ...
              <div class="video-carousel" id="videoCarousel">
                ...
                >
                  <img
                    src="https://img.youtube.com/vi/NBsQkBc_Jsc/mqdefault.jpg"
                    style="width: 100%; height: 100%; object-fit: cover"
                    alt="예고편 2"
                  />
                  <div class="play-icon">▶</div>
                ...
                >
                  <img
                    src="https://img.youtube.com/vi/dOihGQCIw_w/mqdefault.jpg"
                    style="width: 100%; height: 100%; object-fit: cover"
                    alt="예고편 3"
                  />
                  <div class="play-icon">▶</div>
