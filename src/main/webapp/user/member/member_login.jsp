...
<link rel="stylesheet" href="./MEET PLAY SHARE, 메가박스_files/megabox.min.css" media="all">
<script async="" src="./MEET PLAY SHARE, 메가박스_files/gtm.js.다운로드"></script>
<script type="text/javascript" async="" src="./MEET PLAY SHARE, 메가박스_files/js"></script>
...
<script src="./MEET PLAY SHARE, 메가박스_files/megabox.common.min.js.다운로드"></script>
            ...
            <div class="wrapper">
                ...
                <form id="loginForm">
                    ...
                    <div class="link-container">
                        ...
                        <span class="divider">|</span>
                        <a href="member_joinFrm.jsp">회원가입</a>
                    </div>
                    <div>
                    <a href="http://localhost/second_project_movie_reservation/index/quickBookingSeat.jsp">임시 예매페이지</a>
                    </div>
                </form>
            </div>
        </div>
