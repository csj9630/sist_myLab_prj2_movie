    ...
    <div class="main-container-white">
        <div class="wrapper">
            ...
            <div class="tab-container">
                <a href="http://localhost/second_project_movie_reservation/index/member_find_id.jsp" class="tab-item active">아이디 찾기</a>
                <a href="http://localhost/second_project_movie_reservation/index/member_find_pw.jsp" class="tab-item">비밀번호 찾기</a>
            </div>
