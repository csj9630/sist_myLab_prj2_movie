    ...
    <div class="body-wrap">
        ...
        <div class="page-util">
            <div class="inner-wrap">
                <div class="location">
                    <span>Home</span>
                    <a href="http://localhost/second_project_movie_reservation/index/member_login.jsp" title="회원">회원</a>
        ...
        <div class="signup-wrapper" style="margin-bottom: 40px; margin-top: 40px;">
            ...
            <form onsubmit="return false;">
                ...
                <div class="form-group">
                    ...
                    <div class="id-group">
                        <input type="text" class="form-input" id="inputId" placeholder="아이디 입력">
                        <button type="button" class="btn-check" id="btnCheck">중복 확인</button>
                    </div>
                </div>
                ...
                <div class="terms-group">
                    ...
                    <label for="terms">By signing up, I agree with the <a href="#" class="terms-link">Terms of Use</a> & <a href="#" class="terms-link">Privacy Policy</a></label>
                </div>

                <button type="submit" class="btn-submit" id="btnSignup">회원가입</button>
            </form>
        </div>
