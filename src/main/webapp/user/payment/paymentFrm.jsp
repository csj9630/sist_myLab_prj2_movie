...
<link rel="shortcut icon"
	href="http://localhost/second_project_movie_reservation/images/favicon.ico">
<meta name="viewport"
				...
				<div class="mb-8">
					...
					<div class="flex gap-4 border border-gray-200 p-4 rounded-sm">
						<div
							...
							<!-- 이미지 -->
							<img
								src="http://localhost/second_project_movie_reservation/index/MEET%20PLAY%20SHARE,%20%EB%A9%94%EA%B0%80%EB%B0%95%EC%8A%A4_files/YiSbqEf6OvFcDoLoQCipDojOHqMCwKG4_150.jpg"
	...
	<script>
        ...
        function handlePayment() {
            if (!chkTerm1.checked || !chkTerm2.checked) {
                ...
                location.href = 'http://localhost/second_project_movie_reservation/index/payment.jsp'; 
